...
struct ImGuiPlatformIO
{
    ...
    void    (*PlatforupdateWindow)(ImGuiViewport* vp);                    // (Optional) Called in UpdatePlatforms(). Optional hook to allow the platform back-end from doing general book-keeping every frame.

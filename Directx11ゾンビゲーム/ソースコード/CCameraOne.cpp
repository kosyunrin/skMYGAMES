...
void CCameraOne::Update(float dt)
{
	...
	XMStoreFloat3(&SpotDir, Tool::GetNowFaceDir(pp0->GetMatrixForWorld()));
	m_spotlight.direction = SpotDir;
	XMVECTOR SpotPos = XMLoadFloat3(&m_Position) + XMLoadFloat3(&SpotDir)*130.0f;
